        ...
        <div class="principal d-flex">
            ...
            <main class="col-10 m2 d-flex flex-column align-items-center">
                ...
                <div class="show-data bg-light col-11 card">
                    ...
                    <div id="message" class="col-md-4 mx-auto shadow col-lg-6 mb-2 mt-0 d-flex justify-content-between align-items-center alert alert-success rounded" role="alert">
                    ...
                    <table class="table border">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <form action="{{ route('delete_user',$All->id) }}" method="post">
                                    @csrf
                                    @method("DELETE")
