<div class="col-2 m1 bg-light d-flex flex-column gap-4 align-items-center">
...
<div id="menu" class="col-11">
    ...
    <ul class="menu-list">
        <li class="rounded p-2 m-2" id="Dashboard">
            <a wire:navigate class="text-primary d-flex justify-content-around align-items-center" href="/Dashboard" >
        ...
        <a wire:navigate class="text-primary d-flex justify-content-around align-items-center" href="/create">
